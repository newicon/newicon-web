	...
	<div class="main">
        ...
        {/foreach}
			...
			<div class=" shadow-2xl rounded-md rounded-lg overflow-hidden bg-white max-w-screen-xl mx-auto">
				{foreach $featureCards as $card}
					{include file="../_cmps/cards/card_borderless.tpl" flip={cycle values="left,right"}
						title=$card.title
						body=$card.body
						label=$card.label
						image=$card.image}
				...
				<div class="self-center">
					...
					<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 text-center gap-3 ">
						<div class="shadow-xl hover:shadow-2xl transition duration-300 ease-out  p-10">
							<svg class="mx-auto my-8 " width="32" height="32" xmlns="http://www.w3.org/2000/svg">
								<g fill-rule="nonzero" fill="none">
									<path d="M29.41 32H2.59A2.59 2.59 0 010 29.41V2.59A2.59 2.59 0 012.59 0h26.82A2.59 2.59 0 0132 2.59v26.82A2.59 2.59 0 0129.41 32zM2.59 1.36c-.68 0-1.23.55-1.23 1.23v26.82c0 .68.55 1.23 1.23 1.23h26.82c.68 0 1.23-.55 1.23-1.23V2.59c0-.68-.55-1.23-1.23-1.23H2.59z"
										  fill="#A8C5DD"/>
									<path d="M23.62 25.41h-4.81V14.48c0-.1-.19-3.22-2.81-3.22a2.61 2.61 0 00-2 .74 5.47 5.47 0 00-1 3.5v9.88H8.37V6.59h5v1.23a8 8 0 014.06-1 5.68 5.68 0 014.31 1.68c2.08 2.21 1.89 5.74 1.88 5.89v11.02zm-3.47-1.34h2.13v-9.72c0-.07.16-3.15-1.52-4.94a4.37 4.37 0 00-3.33-1.28 5.77 5.77 0 00-4.23 1.48.67.67 0 01-.95.06A.65.65 0 0112 9a.59.59 0 010-.13v-1H9.72v16.2h1.94v-8.5A6.65 6.65 0 0113 11.12a3.91 3.91 0 013-1.2c3.12 0 4.08 3 4.15 4.53v9.62z"
										  fill="#2969F6"/>
								</g>
							</svg>
							<h2 class="text-2xl font-light">Branding</h2>
							<p>
								Our designers work hard to create innovative branding that helps you stand out from the
								crowd.
							</p>
						</div>
						<div class="shadow-xl hover:shadow-2xl transition duration-300 ease-out  p-10">
							<svg class="mx-auto my-8" width="32" height="32" xmlns="http://www.w3.org/2000/svg">
								<g fill-rule="nonzero" fill="none">
									<path d="M22.982 5.663h-7.467a.65.65 0 110-1.3h7.467a.65.65 0 010 1.3zM22.982 9.387h-7.467a.66.66 0 010-1.31h7.467a.66.66 0 010 1.31zM22.982 13.081h-7.467a.65.65 0 110-1.3h7.467a.65.65 0 110 1.3zM22.982 16.795h-7.467a.65.65 0 010-1.28h7.467a.65.65 0 010 1.3v-.02z"
										  fill="#2969F6"/>
									<path d="M29.73 9.348V7.195a2.521 2.521 0 00-2.375-2.502V2.55A2.512 2.512 0 0024.844 0H3.51A2.512 2.512 0 00.97 2.55v16.718a2.522 2.522 0 002.375 2.502v2.191a2.502 2.502 0 002.27 2.483v2.114a2.512 2.512 0 002.511 2.472H29.46A2.512 2.512 0 0032 28.558V11.84a2.512 2.512 0 00-2.27-2.492zm-27.442 9.92V2.55c0-.658.534-1.192 1.193-1.192h21.334c.658 0 1.192.534 1.192 1.192v16.718c0 .66-.532 1.197-1.192 1.202H3.48a1.202 1.202 0 01-1.193-1.202zm2.376 4.693V21.78h20.18a2.512 2.512 0 002.511-2.511V6.022a1.193 1.193 0 011.057 1.173v16.766c0 .659-.534 1.193-1.193 1.193H5.82a1.193 1.193 0 01-1.155-1.193zm26.017 4.597c0 .658-.534 1.192-1.193 1.192H8.155a1.193 1.193 0 01-1.193-1.192v-2.085H27.22a2.512 2.512 0 002.512-2.512V10.667c.556.105.961.588.97 1.154l-.02 16.737z"
										  fill="#A8C5DD"/>
									<path d="M13.13 13.78H4.684V4.353h8.446v9.425zm-7.128-1.32h5.819V5.674H6.002v6.788z"
										  fill="#032663"/>
								</g>
							</svg>
							<h2 class="text-2xl font-light">Pitch Decks</h2>
							<p>
								Need help pitching your project? Our compelling pitch decks to take you to the next
								level.
							</p>
						</div>
						<div class="shadow-xl hover:shadow-2xl transition duration-300 ease-out p-10">
							...
							<p>
								Is your project visually stunning? Our beautiful, bespoke icons and illustrations
						...
						<div class="shadow-xl hover:shadow-2xl transition duration-300 ease-out p-10">
							...
							<p>
								We build responsive and interactive designs to make your user's experience feel
								exceptional.
							</p>
						</div>
					</div>
        ...
        {/layout_container}
        {/layout_section}{extends "layouts/layout.tpl"}
        {block "header"}
            {navigation}
        {/block}
        {block "content"}
			<div class="main">
				...
				<img src="{asset path='/images/illustrations/Architecture UX Illuddstration.svg'}"/>
					...
					<div class=" shadow-2xl rounded-md rounded-lg overflow-hidden bg-white max-w-screen-xl mx-auto">
                        {foreach $featureCards as $card}
							<div class="grid grid-cols-1 grid-rows-2 md:grid-rows-1 md:grid-cols-2 ">
								<img class="w-full h-full object-cover {cycle values="md:order-0,md:order-1"}"
									 src="{asset path=$card.image}" alt="{$card.title} image" class="w-full">
								<div class="flex">
									<div class="px-1/12 py-1/12 md:px-2/12 md:py-20 bg-white self-center">
										<h2 class="text-3xl sm:text-4xl md:text-5xl text-blue-950 pr-10">{$card.title}</h2>
                ...
                {layout_container}
					<div class="min-h-screen flex">
						...
						<div class="self-center">
							...
							<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 text-center gap-3 ">
								<div class="shadow-xl hover:shadow-2xl transition duration-300 ease-out  p-10">
									<svg class="mx-auto my-8 " width="32" height="32"
									...
									<h2 class="text-2xl font-light">Branding</h2>
									<p>
										Our designers work hard to create innovative branding that helps you stand out
										from the
										crowd.
									</p>
								</div>
								<div class="shadow-xl hover:shadow-2xl transition duration-300 ease-out  p-10">
									...
									<h2 class="text-2xl font-light">Pitch Decks</h2>
									<p>
										Need help pitching your project? Our compelling pitch decks to take you to the
										next
										level.
									</p>
								</div>
								<div class="shadow-xl hover:shadow-2xl transition duration-300 ease-out p-10">
									...
									<h2 class="text-2xl font-light">Icons &amp; Illustration</h2>
									<p>
										Is your project visually stunning? Our beautiful, bespoke icons and
										illustrations
										enhance your aesthetics.
									</p>
								</div>
                ...
                {layout_container}
					<img class="absolute top-0 -mt-10 left-0" src="{asset path='/images/temp/callout-image-1.svg'}"
						 alt=""
						 width="277" height="209">
					<h2 class="text-5xl mb-10">Got a specific project in mind?</h2>
					<p class="sm:w-10/12 md:w-8/12 lg:w-6/12 text-xl mb-10 md:mb-15 font-normal">From Digital
						Transformation to
						Augmented Reality, we can help you build your future. Get in touch with us today.</p>
					<div class="flex flex-wrap">
						...
						<div class="mt-8">
							...
							<a href="mailto:hello@neiwcon.net"
                ...
                {layout_container}
					<div class="flex justify-between">
						...
						<div>
							<img class="border-8 border-white rounded-full "
								 src="{asset path='/images/temp/callout-image-2.png'}" alt="" width="250" height="250">
						</div>
					</div>
                {/layout_container}
                {/layout_section}
        ...
        {layout_section class="bg-blue-950 text-white"}
        {layout_container}
			<img class="absolute top-0 -mt-10 left-0" src="{asset path='/images/temp/callout-image-1.svg'}" alt=""
				 width="277" height="209">
			<h2 class="text-5xl mb-10">Got a specific project in mind?</h2>
			<p class="sm:w-10/12 md:w-8/12 lg:w-6/12 text-xl mb-10 md:mb-15 font-normal">From Digital Transformation to
				Augmented Reality, we can help you build your future. Get in touch with us today.</p>
			<div class="flex flex-wrap">
				<button class="mt-8 order-last md:order-first w-full md:mr-1/12 md:w-4/12 lg:w-3/12 btn btn-primary btn-fx btn-lg">
					Send us a message
		...
		{layout_section class="bg-gray-300 "}
			{layout_container}
				<div class="flex justify-between">
					<div class="w-6/12 mr-1/12">
						<h2 class="text-3xl text-blue-950">Need some advice?</h2>
						<p class="text-xl font-light text-blue-950">Looking to utilise digital technology to streamline your
							operations or launch new products and services, contact our digital strategy director Mark for a
							free consultation.</p>
						<button class="mt-5 btn btn-outline-primary px-12 py-4 btn-fx border-blue-950 text-blue-950">Book a
							call
						</button>
					</div>
					<div>
