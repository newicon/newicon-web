			...
			<div class="section_body">
				...
				<div class="servicesSecondary">
					<div class="serviceSecondary">
						<div class="service_inner">
							<div class="service_image">
								<img src="assets/images/temp/service-image-5.png" alt="" width="132" height="106">
							</div><!-- /.service_image -->
							...
							<div class="service_content">
								...
								<p>
									Your bottom line is everything. That’s why we offer digital marketing that’s proven to deliver a strong, measurable ROI, no matter what you're selling.
								</p>
							</div><!-- /.service_content -->
						</div><!-- /.service_inner -->
					...
					<div class="serviceSecondary">
						<div class="service_inner">
							...
							<div class="service_content">
								...
								<h5>Crafting content that converts</h5>

								<p>
									Using our experience in conversion rate optimisation (CRO), we ensure that people who click on your ads are more likely to convert into customers.
								</p>
							</div><!-- /.service_content -->

							<div class="service_imageText">
								<img src="assets/images/temp/service-image-text.png" alt="" width="266" height="157">
					...
					<div class="serviceSecondary">
						<div class="service_inner">
							<div class="service_image">
								<img src="assets/images/temp/service-image-7.png" alt="" width="132" height="106">
							</div><!-- /.service_image -->

							<div class="service_content">
								<h3>Rise to the top</h3>

								<h5>The power of "page one"</h5>

								<p>
									Our SEO and PPC services will ensure that your business is the first one people see when they search online for your products or services. Visibility is key.
								</p>
							</div><!-- /.service_content -->
						</div><!-- /.service_inner -->
					</div><!-- /.serviceSecondary -->
			...
			<div class="sectionContent">
				<div class="articlesSmall">
					<div class="articleSmall">
						<div class="article_inner">
							<div class="article_image">
								<img src="assets/images/temp/article-image-1.jpg" alt="" width="675" height="457">
							</div><!-- /.article_image -->
							...
							<div class="article_content">
								...
								<div class="article_entry">
									...
									<a href="#" class="link">
										...
										<i class="ico-arrow-right-secondary"></i>
									</a>
								</div><!-- /.article_entry -->
							</div><!-- /.article_content -->
						</div><!-- /.article_inner -->
					...
					<div class="articleSmall">
						<div class="article_inner">
							<div class="article_image">
								<img src="assets/images/temp/article-image-2.jpg" alt="" width="675" height="457">
							</div><!-- /.article_image -->
							...
							<div class="article_content">
								...
								<div class="article_entry">
									...
									<a href="#" class="btn btn-primary btn-outline">See our work</a>
								</div><!-- /.article_entry -->
							</div><!-- /.article_content -->
						</div><!-- /.article_inner -->
					</div><!-- /.articleSmall -->
					...
					<div class="articleSmall">
						<div class="article_inner">
							<div class="article_image">
								<img src="assets/images/temp/article-image-3.jpg" alt="" width="675" height="457">
							</div><!-- /.article_image -->
							...
							<div class="article_content">
								...
								<div class="article_entry">
									<h6>Quick, Measurable Results</h6>
					...
					<div class="articleSmall">
						<div class="article_inner">
							<div class="article_image">
								<img src="assets/images/temp/article-image-4.jpg" alt="" width="675" height="457">
							</div><!-- /.article_image -->
							...
							<div class="article_content">
								...
								<div class="article_entry">
									<h6>Take Control Of Your Online Presence </h6>
						...
						<div class="slider_slides cards">
							<div class="slider_slide card card-secondary">
								...
								<div class="card_imageText card_imageText-position6">
									<img src="assets/images/temp/card-image-text-6.png" alt="" width="173" height="70">
								</div><!-- /.card_imageText -->
							</div><!-- /.slider_slide -->
