						...
						<div class="article_inner">
							<div class="article_content">
								<div class="article_entry">
									<h6 class="article_subtitle">News</h6>

									<h2 class="article_title">Newicon, TEDxBristol, and the dawn of a new tomorrow</h2>
										...
										<div class="blogPost_inner">
											<div class="subscribe">
												<div class="subscribe_content">
													<h2 class="subscribe_title">Bringing you the freshest article and resources on Software Development, UX Design and The Web</h2>
								...
								<div class="widgets">
									<div class="widget">
										<div class="widget_head">
											<h5 class="widget_title">Most Popular</h5>
										</div>
									...
									<div class="widget">
										<div class="widget_head">
											<h5 class="widget_title">Downloads</h5>
										</div>

										<div class="widget_body">
											<div class="offer">
												<div class="offer_content">
													<h3 class="offer_title">Take Your Business To The Next Level</h3>

													<h5 class="offer_subtitle">Introducing Newicon’s Innovation Kit</h5>
