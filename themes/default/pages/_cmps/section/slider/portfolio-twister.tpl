...
{css id=glide}
	<style>
		...
		.screenshot { opacity: 1; transition: transform .4s ease-out;  transform: scale(0.9) rotate(-3deg); box-shadow:none; }
		...
		@media (min-width: 1024px) {
			...
			.screenshot { transition: opacity .4s ease-out; opacity: 0; transform:scale(0.9) rotate(-10deg); box-shadow:none; }
