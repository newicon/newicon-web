...
{*		<img src="{asset path=$image}" alt="{$alt|default:"$title image"}" class="w-full h-full object-cover group-hover:scale-110 transform duration-1000 ease-out" >*}
        {image_srcset min-break="728px" firefly_id={asset path=$image} alt=$alt|default:"$title image" sizes="(min-width: 728px) 728px, 100vw" breaks="728px, 100vw" class="w-full h-full object-cover group-hover:scale-110 transform duration-1000 ease-out" }
	</div>
	<div class="flex z-10 ">
