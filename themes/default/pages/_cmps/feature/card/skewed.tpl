...
{*		<img src="{asset path=$image}" alt="{$alt|default:"$title image"}" class="w-full h-full object-cover group-hover:scale-110 transform duration-1000 ease-out" >*}
        {image_srcset firefly_id={asset path=$image} alt=$alt|default:"$title image" class="w-full h-full object-cover group-hover:scale-110 transform duration-1000 ease-out" }
	</div>
	<div class="flex z-10 ">
