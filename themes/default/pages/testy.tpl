...
{*    {image_srcset firefly_id="http://localhost/newicon-website/public/assets/c5ccad7a/images/photos/rich-and-george-ipad.jpg?v=1585404202" class="w-full h-full object-cover group-hover:scale-110 transform duration-1000 ease-out" }*}
    {image_srcset firefly_id="http://localhost/newicon-website/public/assets/c5ccad7a/images/photos/iphone-user-screenshot.jpg?v=1584340174" class="w-full h-full object-cover group-hover:scale-110 transform duration-1000 ease-out" }
