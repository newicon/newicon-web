					...
					<div class="slider_slides">
						<div class="slider_slide">
							...
							<div class="slider_slideContent">
								<div class="slider_slideEntry">
									...
									<h3 class="slider_title">BBSP</h3><!-- /.slider_title -->
							...
							<div class="slider_slideImage">
								<img src="{asset path='images/work/thumbs/bbsp-with-shadow.svg'}" alt="" width="1052" height="1145">
						...
						<div class="slider_slide">
							...
							<div class="slider_slideContent">
								<div class="slider_slideEntry">
									...
									<h3 class="slider_title">Genuine Impact</h3><!-- /.slider_title -->
						...
						<div class="slider_slide">
							...
							<div class="slider_slideContent">
								<div class="slider_slideEntry">
									...
									<h3 class="slider_title">Renewable Exchange</h3><!-- /.slider_title -->
						...
						<div class="slider_slide">
							...
							<div class="slider_slideContent">
								<div class="slider_slideEntry">
									...
									<h3 class="slider_title">TEDxBristol</h3><!-- /.slider_title -->
						...
						<div class="slider_slide">
							<div class="slider_slideContent">
								<div class="slider_slideEntry">
									<h6 class="slider_subtitle">Case Study</h6><!-- /.slider_subtitle -->
									<h3 class="slider_title">Palladium</h3><!-- /.slider_title -->
							...
							<div class="slider_slideImage">
								<img src="{asset path='images/work/thumbs/palladium-angled-with-shadow.svg'}" alt="" width="1052" height="1145">
							</div><!-- /.slider_slideImage -->
						</div><!-- /.slider_slide -->
					</div><!-- /.slider_slides -->
				</div><!-- /.slider_clip -->
