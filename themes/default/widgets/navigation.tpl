		...
		<ul class="md:flex justify-around m-0">
			...
			{foreach $menu as $key => $link}
				<li class="{$liClass}" >
					...
					{if isset($link.children)}
						<div class="{$key}_dropdown transform ease-in-out -translate-x-1/2 left-1/2 pointer-top absolute z-50 shadow-3xl bg-white md:p-8 lg:p-9 rounded-md origin-top transition-opacity-transform duration-300 pointer-events-none group-hover:pointer-events-auto opacity-0 group-hover:opacity-100 transform scale-90 group-hover:scale-100">
