...
class m20190712_235802_add_cms_page_newicon_culture extends Migration
{
	public function safeUp()
	{
		...
		$this->insert('cms_url', ['url' => '/newicon-culture', 'nice_id' => 'newicon-culture']);
	}

	public function safeDown()
	{
		$this->delete('cms_url', ['nice_id'=>'newicon-culture']);
		$this->delete('cms_page', ['nice_id'=>'newicon-culture']);
	}
}